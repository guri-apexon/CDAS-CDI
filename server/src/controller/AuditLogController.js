...
exports.searchList = function (req, res) {
  try {
    ...
    const searchQuery = `SELECT al.*, CONCAT(al.audit_vers, '.0') as log_version, to_char(al.audit_updt_dt , 'DD-mon-YYYY HH:MI AM') as update_dt, u.usr_fst_nm || ' ' || u.usr_lst_nm as user_name, dp.name from ${constants.DB_SCHEMA_NAME}.dataflow_audit_log as al

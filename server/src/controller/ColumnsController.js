...
exports.createColumnSet = async (req, res) => {
  try {
    ...
    const insertQuery = `INSERT INTO cdascdi.columndefinition (columnid, "VARIABLE", datasetid, "name", "datatype", primarykey, required, charactermin, charactermax, "position", "FORMAT", lov, "UNIQUE", insrt_tm, updt_tm)

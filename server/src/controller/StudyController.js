...
exports.getUserStudyList = function (req, res) {
  try {
    ...
    WHERE prot_id in (select prot_id from ${schemaName}.study_user where usr_id=$1 and act_flg=1) order by "priorityCount" desc, "ingestionCount" desc, "staleFilesCount" desc, sponsorname asc, protocolnumber asc`;
